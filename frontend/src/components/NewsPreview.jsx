...
export default function NewsPreview({ limit = 2 }) {
  ...
  return (
    <>
      <div className="space-y-6">
        {/* heading */}
        <div>
          <h2 className="font-display text-4xl leading-none text-pl-text md:text-5xl">
            In the News
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          {items?.map((item, index) => {
            ...
            const date = item?.date || item?.publishedAt || "Recent Update";

            const heading = item?.title || item?.heading || "Untitled";
            ...
            const link = item?.link || item?.url || "/articles-updates";
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <span className="shrink-0 text-xs text-pl-muted">{date}</span>
                </div>
